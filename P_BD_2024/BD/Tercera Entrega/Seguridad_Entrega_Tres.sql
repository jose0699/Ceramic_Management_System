...
--USUARIO MAESTRO
	BEGIN; CREATE USER DBA WITH PASSWORD 'ADMIN'; COMMIT;
...
--SECRETARIA
	BEGIN; GRANT INSERT, UPDATE(FECHA_FIN), SELECT ON DBA.FAMILIAR_HISTORICO_PRECIO TO SECRETARIA; COMMIT;
	...
	BEGIN; GRANT INSERT, SELECT ON DBA.VAJILLA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.DETALLE_PIEZA_VAJILLA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.PIEZA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.COLECCION TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.CLIENTE TO SECRETARIA; COMMIT;
...
--GERENTE_PLANTA
	...
	BEGIN; GRANT INSERT, SELECT ON DBA.PIEZA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.COLECCION TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT, UPDATE(FECHA_FIN), SELECT ON DBA.FAMILIAR_HISTORICO_PRECIO TO GERENTE_PLANTA; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON DBA.CLIENTE TO GERENTE_PLANTA; COMMIT;
...
--TECNICO
	...
	BEGIN; GRANT INSERT, SELECT ON DBA.HORARIO TO Daniel_Guerrero; COMMIT;
