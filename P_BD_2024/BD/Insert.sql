...
/* Gerentes */					 /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),21474659,'1975-07-21','B-','F','Calle principal de la candelaria','qui','ge',3500,04149116300,1,'María','González',null,'Pérez');-- General  1
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 18934567, '1970-10-24', 'A-', 'F', 'Calle El Triunfo, Res. Las Palmeras', 'mec','ge', 3500, 04167891234, 2, 'Ana', 'Romero',null, 'Vargas',null);-- Planta  2
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 20876543, '1964-04-25', 'B+', 'M', 'Avenida Bolívar, Urb. La Colina', 'pro','ge', 3500, 04243215678, 4, 'Daniel', 'Guerrero',null, 'Mendoza',null);-- Tecnica   3


/* Supervisores */  		 /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),27748963,'1987-10-03','A+','M','Avenida Este cero','ind','og',1500,04149116305,5,'Carlos','Torres',null,'Ramírez');--4  
insert into empleado values(nextval('empleado_exp_seq'),27474666,'1989-01-03','O-','M','Avenida Morat','ind','og',1500,04149116307,8,'Luis','Blanco',null,'Fernández');--5 	
insert into empleado values(nextval('empleado_exp_seq'),27474665,'1988-02-03','B-','F','Calle Felicidad','ind','og',1500,04149116306,9,'Carolina','Sánchez',null,'Martínez');--6   
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27474667, '1984-06-03', 'O-', 'M', 'Avenida Morat', 'ind', 'og', 1500, 04149116307, 10, 'María', 'González',null, 'López');--7
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27441986, '1983-05-20', 'O-', 'M', 'Avenida Trusk', 'ind', 'og', 1500, 04149116107, 11, 'Luis', 'Blanco',null, 'Rotos');--8 	
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27365666, '1982-08-03', 'A-', 'M', 'Avenida Del Moratorio', 'mec', 'og', 1500, 04149112407, 12, 'Carlos', 'Blanco',null, 'Fernández');--9 	
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27364666, '1981-07-03', 'AB-', 'F', 'Avenida Morat', 'ind', 'og', 1500, 04149119007, 13, 'María', 'González',null, 'López');--10  		
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27363666, '1980-11-03', 'O-', 'M', 'Calle Real, 123', 'ind', 'og', 1500, 04149124569,14, 'Yuritza', 'Castillo',null, 'Rodriguez');--11	
INSERT INTO empleado VALUES (nextval('empleado_exp_seq'), 27362666, '1985-10-03', 'B+', 'M', 'Avenida Morat', 'ind', 'og', 1500, 04145154269, 15, 'Luis', 'Blanco',null, 'Fernández');--12 
...
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24485673, '1990-05-09', 'B-', 'F', 'Avenida Boulevard', 'ba','se', 2100, 04147896543, 3, 'Valentina', 'Harrison',null, 'Pérez',null );--14
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 26321549, '1993-07-08', 'O+', 'M', 'Calle Principal', 'ba','se', 2100, 04265473210, 3, 'Alejandro', 'Guzmán',null, 'López',null );--15
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24210987, '2000-10-07', 'AB-', 'F', 'Avenida La Paz', 'ba','se', 2100, 04128765432, 3, 'Sandra', 'Mendoza',null, 'Martínez', null);--16

/* Seccion de control  */--6   		 /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),27403661,'1997-11-03','A+','F','Calle Esperanza de la cruz','pro','in',1400,04149116302,6,'Ana','Romero',null,'Flores',null);--17
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 23254321, '2000-03-05', 'B-', 'M', 'Avenida Universidad', 'pro','in', 1400, 04241234567, 6, 'Pedro', 'González',null, 'López', null);--18

/* Seccion de mantenimiento*/--7		 /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),24360661,'2001-06-03','A+','F','Calle Esperanza de la cruz','pro','el',850,04149116302,7,'Ana','Romero',null,'Flores',null);--19
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 25147362, '1994-06-07', 'O+', 'M', 'Avenida Libertador', 'pro','me', 850, 04162345678, 7, 'Luis', 'Muñoz',null, 'García', null);--20

/*  Almacen de insumos */--5 		/*listo*/
insert into empleado values(nextval('empleado_exp_seq'),27474661,'1994-06-03','A+','F','Calle Esperanza de la cruz','pro','og',2000,04149116302,5,'Ana','Romero',null,'Flores',4);--21
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 23372615, '1987-08-09', 'AB+', 'M', 'Avenida Morán','pro','og', 2000, 04283654721, 5, 'Carlos', 'Blanco',null, 'Méndez',4);--22

/*Almacen de producto terminado */--8		 /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),28568661,'2001-06-03','A+','F','Calle Esperanza de la cruz','pro','og',2900,04149116302,8,'Ana','Romero',null,'Flores',5);--23
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 28261548, '2002-06-06', 'B-', 'F', 'Avenida Las Américas','pro','og', 2900, 04125432109, 8, 'María', 'Gómez',null, 'Pérez',5);--24

/*  Operarios */ 			/*listo*/
insert into empleado values(nextval('empleado_exp_seq'),28474660,'2002-04-03','O-','M','Avenida Libertad Solarium','ind','og',2600,04149116301,9,'Pedro','López',null,'García',6);--25
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 28251432, '2001-06-09', 'A+', 'F', 'Calle Principal', 'ind','og', 2600, 04267345123, 9, 'Gabriela', 'Martínez',null, 'Silva',6);--26
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 22548736, '1987-07-08', 'B-', 'M', 'Avenida Bolívar', 'ind','og', 2600, 04143256789, 10, 'Luis', 'Ramírez',null, 'Blanco',7);--27
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24721369, '1991-03-07', 'AB+', 'F', 'Calle Miranda', 'ind','og', 2600, 04281234567, 10, 'Andrea', 'Guerrero',null, 'Pérez', 7);--28
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 23832147, '2000-11-06', 'O-', 'M', 'Avenida Sucre', 'ind','og', 2600, 04165432109, 11, 'Carlos', 'Suárez',null, 'López', 8);--29
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24943258, '2002-06-05', 'A+', 'F', 'Calle Vargas', 'ind','og', 2600, 04242345678, 11, 'Isabel', 'Muñoz',null, 'García',8);--30
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24054369, '2003-03-24', 'B-', 'M', 'Avenida Páez', 'ind','og', 2600, 04187654321, 12, 'Daniel', 'Romero',null, 'Flores', 9);--31
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24165470, '1995-01-03', 'AB+', 'F', 'Calle Cedeño', 'ind','og', 2600, 04224321098, 12, 'Jennifer', 'Gómez',null, 'Pérez', 9);--32
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24276581, '2001-07-02', 'O-', 'M', 'Avenida Falcón', 'ind','og', 2600, 04145678901, 13, 'José', 'López',null, 'García',10);--33
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24387692, '1990-05-01', 'A+', 'F', 'Calle Carabobo','ind','og', 2600, 04263456789, 13, 'María', 'Ramírez',null, 'Blanco',10);--34

/* Horneros  */ /*listo*/
insert into empleado values(nextval('empleado_exp_seq'),24474670,'2003-06-03','B-', 'M','Avenida  Solarium','ba','og',2600,04149116301,15,'Paco','Gutierrez',null,'García',12);--35
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24509815, '2002-05-30', 'AB+', 'F', 'Calle Boyacá','ba','og', 2600, 04247654321, 15, 'Ana', 'Suárez',null, 'López',12);--36
insert into empleado values(nextval('empleado_exp_seq'),27474663,'2000-06-03','B-','M','Avenida Progreso movimiento','ba','og',1900,0414911703,15,'Juan','Muñoz',null,'Vega',12);--37
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 26362516, '1997-04-09', 'A+', 'F', 'Calle Libertad','ba','og', 1900, 04283654721, 15, 'Gabriela', 'Pérez',null, 'García',12);--38

/*  otro departamento   */ 			/*listo*/
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 27273645, '1999-06-08', 'B-', 'M', 'Avenida Morán','geo','og', 1900, 04162345678, 14, 'Luis', 'Gómez',null, 'López',11);--39
INSERT INTO empleado VALUES(nextval('empleado_exp_seq'), 24184756, '1998-06-07', 'AB+', 'F', 'Calle Miranda', 'geo','og', 1900, 04241234567, 14, 'Andrea', 'Blanco',null, 'Méndez',11);--40


/* reunion */ 			/*listo*/
insert into reunion values (4,'2024-05-03','Se comentó sobre la productividad general de la fabrica');
insert into reunion values (4,'2024-05-10','Se comentó sobre el rendmiento de la fábrica');
insert into reunion values (4,'2024-05-17','Se discutió la falta de comunicación en el equipo');
insert into reunion values (4,'2024-05-24','Asignacion de horarios del mes');
insert into reunion values (5,'2024-05-03','Resumen de la semana');
insert into reunion values (5,'2024-05-10','Resumen de la semana');
insert into reunion values (7,'2024-05-03','Se chequeo el desempeño de esa semana');
insert into reunion values (6,'2024-05-10','Se chequeo el desempeño de esa semana');
insert into reunion values (8,'2024-05-24','Informacion sobre bonos');
insert into reunion values (8,'2024-05-10','Resumen de la semana');
insert into reunion values (9,'2024-05-31','Informacion sobre bonos');
insert into reunion values (12,'2024-05-03','Resumen de planificación de la semana');
insert into reunion values (12,'2024-05-31','Información sobre nuevos horarios para el mes de Junio');
...
insert into HIST_TURNO values (12,'2024-05-01',2);
insert into HIST_TURNO values (36,'2024-06-01',2);
insert into HIST_TURNO values (37,'2024-06-01',2);
insert into HIST_TURNO values (38,'2024-06-01',3);
insert into HIST_TURNO values (35,'2024-06-01',1);
insert into HIST_TURNO values (12,'2024-06-01',3);
...
insert into det_exp values(35,nextval('det_exp_uid_seq'),'2024-05-17','in',null);
...
insert into det_exp values(35,nextval('det_exp_uid_seq'),'2024-05-16','in',null);
...
insert into INASISTENCIA values (4,'2024-05-03',26);
insert into INASISTENCIA values (4,'2024-05-24',26);
insert into INASISTENCIA values (5,'2024-05-03',26);
insert into INASISTENCIA values (5,'2024-05-10',40);
insert into INASISTENCIA values (7,'2024-05-03',40);
insert into INASISTENCIA values (6,'2024-05-10',35);
insert into INASISTENCIA values (8,'2024-05-24',34);
insert into INASISTENCIA values (8,'2024-05-10',34);
insert into INASISTENCIA values (9,'2024-05-31',33);
insert into INASISTENCIA values (12,'2024-05-31',36);
insert into INASISTENCIA values (12,'2024-05-31',37);
insert into INASISTENCIA values (12,'2024-05-03',37);
...
insert into E_E values (35, 2,'Tiene enfermedad de válvulas cardiacas');
...
insert into molde values(nextval ('molde_uid_seq'),'AZ','9x10cm',null,6); --7
...
insert into pieza values(1,nextval ('pieza_uid_seq'),'Guacamaya Tropical: Un festín de colores para tu mesa.',null,26);--2
insert into pieza values (1,nextval ('pieza_uid_seq'),'Guacamaya Emblemática: Un homenaje a la belleza de las aves tropicales.',null,27);--5
insert into pieza values (1,nextval ('pieza_uid_seq'),'Guacamaya Artesanal: Un producto elaborado con pasión y cuidado.',null,28);--6




insert into pieza values (1,nextval ('pieza_uid_seq'),'Samauma Raíces: Un homenaje a la fuerza y la estabilidad.',null,21);--17
...
insert into pieza values (2,nextval ('pieza_uid_seq'),'Florecer: simple y poético que evoca la belleza de las flores de cerezo en plena floración.',null,25);--31
insert into pieza values (2,nextval ('pieza_uid_seq'),'Primavera Viva: alegre y vibrante que transmite la energía y la frescura de la temporada primaveral.',null,20);--32
...
insert into pieza values (2,nextval ('pieza_uid_seq'),'Jardín Encantado: Delicados platos de cerámica pintados a mano con motivos de un jardín rojo en flor,',null,20);--46
...
insert into pieza values (2,nextval ('pieza_uid_seq'),'Sabores del Verano: Sirve tus platos favoritos con estilo en estos platos de cerámica con diseños de jardines rojos, ideales para cualquier ocasión.',null,26);--46
...
insert into pieza values (3,nextval ('pieza_uid_seq'),'Delicia Elegante: Delicados platos de cerámica pintados a mano con motivos de la tradicional hora del té,',null,27);--46
insert into pieza values (3,nextval ('pieza_uid_seq'),'Sinfonía de Sabores: Disfruta de tus dulces y salados favoritos en estos vibrantes platos adornados con tazas de té, sándwiches y pasteles, disponibles en una variedad de colores para combinar con tu decoración.',null,25);--46
