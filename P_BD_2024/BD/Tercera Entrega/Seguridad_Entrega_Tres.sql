...
--OPERARIO
	BEGIN; GRANT SELECT ON E_R TO OPERARIO; COMMIT;
	BEGIN; GRANT SELECT ON RESUMEN_REUNION TO OPERARIO; COMMIT; 
...
--HORNERO
	BEGIN; GRANT SELECT ON HORARIO TO HORNERO; COMMIT;
	
--SUPERVISOR
	BEGIN; GRANT INSERT ON RESUMEN_REUNION TO SUPERVISOR; COMMIT;
	BEGIN; GRANT INSERT ON E_R TO SUPERVISOR; COMMIT;
...
--SECRETARIA
	...
	BEGIN; GRANT INSERT, SELECT ON CLIENTE TO SECRETARIA; COMMIT;
...
--GERENTE_PLANTA
	...
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE uid_pieza TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE uid_coleccion TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE uid_juego TO SECRETARIA; COMMIT;
...
--TECNICO
	...
	BEGIN; GRANT SELECT ON RESUMEN_REUNION TO Daniel_Guerrero; COMMIT;
	BEGIN; GRANT SELECT ON E_R TO Daniel_Guerrero; COMMIT;
	BEGIN; GRANT INSERT, SELECT ON HORARIO TO Daniel_Guerrero; COMMIT;
