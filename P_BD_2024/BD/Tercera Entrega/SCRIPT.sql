...
--GERENTE_PLANTA
	BEGIN; GRANT INSERT ON PIEZA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT ON VAJILLA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT ON DETALLE_PIEZA_VAJILLA TO SECRETARIA; COMMIT;
	BEGIN; GRANT INSERT ON COLECCION TO SECRETARIA; COMMIT;
	...
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE pieza_uid_seq TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE coleccion_uid_seq TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE vajilla_uid_seq TO SECRETARIA; COMMIT;

	BEGIN; GRANT SELECT, USAGE ON SEQUENCE factura_uid_seq TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE pedido_uid_seq TO SECRETARIA; COMMIT;
	BEGIN; GRANT SELECT, USAGE ON SEQUENCE contrato_uid_seq TO SECRETARIA; COMMIT;
