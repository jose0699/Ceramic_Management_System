...
/*pedido*/
BEGIN;	insert into pedido values(1,nextval('pedido_uid_seq') ,'2024-04-18' ,'2024-06-18','2024-04-04' , 'A','F' );	COMMIT;--1
BEGIN;  insert into pedido values(2,nextval('pedido_uid_seq') ,'2024-02-17' ,'2024-04-17','2024-04-17'  , 'E','I' );	COMMIT;--2
BEGIN;	insert into pedido values(3,nextval('pedido_uid_seq') ,'2024-04-16' ,'2024-06-16','2024-04-30'  , 'A','F' );	COMMIT;--3
...
BEGIN;	insert into pedido values(2,nextval('pedido_uid_seq') ,'2024-04-11' ,'2024-06-11','2024-04-11'  , 'A','F' );	COMMIT;--8
BEGIN;	insert into pedido values(3,nextval('pedido_uid_seq') ,'2024-04-10' ,'2024-06-10','2024-06-10' , 'A','F' );	COMMIT;--9
--Tablas Intercepcion

/*Factura*/
BEGIN;	insert into factura values( 1,1,nextval('factura_uid_seq') ,'2024-05-18' , 605.8 );	COMMIT;--1
BEGIN;	insert into factura values( 3,9,nextval('factura_uid_seq') ,'2024-05-10', 43.20 );	COMMIT; --2 
BEGIN;	insert into factura values( 3,3,nextval('factura_uid_seq') ,'2024-05-16' , 420 );	COMMIT;--3
BEGIN;	insert into factura values( 5,5,nextval('factura_uid_seq') ,'2024-06-14' , 324);	COMMIT; --4
BEGIN;	insert into factura values( 2,8,nextval('factura_uid_seq') ,'2024-05-11', 1621.80 );	COMMIT; --5
BEGIN;	insert into factura values( 4,4,nextval('factura_uid_seq') ,'2024-05-15', 249.65 );	COMMIT; --6
...
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 1,15 ,2 );	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 2,15 ,null,1,5);	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 3,15 ,null,1,6);	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 4,15 ,null,1,7 );	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 5,15 ,null,1,8 );	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 6,15 ,null,1,9);	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 2,8, 7,15 ,null,1,10 );	COMMIT;
BEGIN;	insert into DETALLE_PEDIDO_PIEZA values( 3,9, 1,18 ,null, 3,27);	COMMIT;
